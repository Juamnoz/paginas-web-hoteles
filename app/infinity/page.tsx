    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="w-full px-2">
          ...
          >
            <iframe
              src="https://maps.google.com/maps?q=Infinity+Hotel+Laureles+Medellín+La+70&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="180"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ubicación Infinity Hotel"
            />
          </div>
          <a
            href="https://www.google.com/maps/search/Infinity+Hotel+Laureles+Medellín"
            target="_blank"
            rel="noopener noreferrer"
