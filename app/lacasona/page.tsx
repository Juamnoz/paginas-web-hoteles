      ...
      >
        ...
        <motion.div variants={itemVariants} className="w-full px-2">
          <div
            ...
            style={{ border: "1px solid #edddd0" }}
          >
            <iframe
              src="https://maps.google.com/maps?q=La+Casona+Hotel+Boutique+Laureles+Medellín&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="180"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ubicación La Casona Hotel Boutique"
            />
          </div>
          <a
            href="https://www.google.com/maps/search/La+Casona+Hotel+Boutique+Laureles+Medellín"
            target="_blank"
            rel="noopener noreferrer"
